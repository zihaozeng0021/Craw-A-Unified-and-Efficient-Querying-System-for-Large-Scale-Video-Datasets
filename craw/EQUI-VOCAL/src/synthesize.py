...
if __name__ == '__main__':
    ...
    'user_study_queries_scene_graph-simulated_user_error', 'custom_dataset',
    ...
    if dataset_name.startswith("trajectories_handwritten") or dataset_name.startswith("trajectories_duration"):
    ...
    elif dataset_name.startswith("without_duration") | dataset_name.startswith("custom_dataset"):
        query_strs = [
            "(Near(o0, o1, 2.0))", 
            "(BottomQuadrant(o0), Near(o0, o1, 1.0))",
            "(BottomQuadrant(o0), Near(o0, o1, 2.0))",
        ...
        if method_str in ["quivr_original", "quivr_original_no_kleene", "quivr_original_active_learning", "quivr_original_no_kleene_active_learning"]:
            ...
            predicate_dicts = [
                [{"name": "Near", "parameters": [2], "nargs": 2}],
